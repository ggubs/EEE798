...
% draw elements
scatter3(pos(1,:),pos(2,:),pos(3,:), LineWidth=2)
hold off
axis(ax,'vis3d');
axis(ax,'equal');
axis(ax,'off');
    ...
    function add_x_y_z_labels(axes1, rad)
        ...
        plot3( axes1, [0,1],[0,0],[0,0],'r','LineWidth',1.5 );
        text(axes1,1.1*rad,0,0, 'x');

        plot3( axes1, [0,0],[0,1],[0,0],'g','LineWidth',1.5 );
        text(axes1,0,1.05*rad,0, 'y');

        plot3( axes1, [0,0],[0,0],[0,1],'b','LineWidth',1.5 );
        text(axes1,0,0,1.05*rad, 'z');
    end
